...
import { TileLayer, _Tile2DHeader as Tile2DHeader, _TileLoadProps as TileLoadProps } from '@deck.gl/geo-layers/typed';
/** All properties supported by SpatialIndexTileLayer. */
export declare type SpatialIndexTileLayerProps<DataT = any> = _SpatialIndexTileLayerProps<DataT> & TileLayer<DataT>;
